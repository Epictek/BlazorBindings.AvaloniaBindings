...
namespace BlazorBindings.Avalonia.Elements
{
    ...
    /// </summary>
    public partial class DataGrid<T> : TemplatedControl
    {
        static DataGrid()
        {
        ...
        protected override void RenderAdditionalElementContent(RenderTreeBuilder builder, ref int sequence)
        {
            ...
            RenderTreeBuilderHelper.AddControlTemplateProperty<AC.DataGrid, AC.ITemplate<AvaloniaPage>>(builder, sequence++, DropLocationIndicatorTemplate,
