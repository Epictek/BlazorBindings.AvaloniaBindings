...
namespace BlazorBindings.Avalonia.Elements
{
        ...
        internal static void RegisterAdditionalHandlers()
        {
            AttachedPropertyRegistry.RegisterAttachedPropertyHandler("Visual.FlowDirection",
                (element, value) => 
                {
                    ...
                    {
                        A.Visual.SetFlowDirection((A.Visual)element, (A.Media.FlowDirection)value);
                    }
                });
        }
    }
    ...
    public class Visual_Attachment : NativeControlComponentBase, INonPhysicalChild, IContainerElementHandler
    {
        ...
        private void TryUpdateParent(object parentElement)
        {
            ...
            {
                if (FlowDirection == A.Visual.FlowDirectionProperty.GetDefaultValue(parentElement.GetType()))
                {
                    ((A.Visual)parentElement).ClearValue(A.Visual.FlowDirectionProperty);
                }
                else
                {
                    A.Visual.SetFlowDirection((A.Visual)parentElement, FlowDirection);
                }
        ...
        void INonPhysicalChild.SetParent(object parentElement)
        {
            ...
            {
                FlowDirection = FlowDirection != default ? FlowDirection : A.Visual.FlowDirectionProperty.GetDefaultValue(parentType);

                TryUpdateParent(parentElement);
            }

            _parent = (A.Visual)parentElement;
        }
        ...
        public void RemoveFromParent(object parentElement)
        {
            ...
            if (parentType is not null)
            {
                FlowDirection = A.Visual.FlowDirectionProperty.GetDefaultValue(parentType);
