        ...
        protected override void HandleParameter(string name, object value)
        {
            switch (name)
            {
                ...
                case nameof(OnBarcodesDetected):
                    ...
                    {
                        void NativeControlBarcodesDetected(object sender, BarcodeDetectionEventArgs e) => OnBarcodesDetected.InvokeAsync(e);
                ...
                case nameof(OnFrameReady):
                    ...
                    {
                        void NativeControlFrameReady(object sender, CameraFrameBufferEventArgs e) => OnFrameReady.InvokeAsync(e);
